...
import com.example.diana.menutest1.places.RecyclerViewAdapter4;
...
public class FragmentTools extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lstPlace.add(new Place("прогулка по центру ",R.drawable.marsh2));
        lstPlace.add(new Place("прогулка до лесопарка ",R.drawable.marsh));


        RecyclerViewAdapter4 myAdapter = new RecyclerViewAdapter4 (lstPlace);

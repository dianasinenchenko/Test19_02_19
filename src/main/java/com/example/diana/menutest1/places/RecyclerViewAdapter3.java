...
public class RecyclerViewAdapter3 extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>  {
    private List<Place> mData ;


    public RecyclerViewAdapter3( List<Place> mData) {
    ...
    public void onBindViewHolder(RecyclerViewAdapter.MyViewHolder holder, final int position2) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (position2){
                    case 0:
                        Intent intent0=new Intent(v.getContext(),ArchitectureActivityMap.class);
                        v.getContext().startActivity(intent0);
                        break;
                    case 1:
                        Intent intent1=new Intent(v.getContext(),ArchitectureActivityMap.class);
                        v.getContext().startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2=new Intent(v.getContext(),ArchitectureActivityMap.class);

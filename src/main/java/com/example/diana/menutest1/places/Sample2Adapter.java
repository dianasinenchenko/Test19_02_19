...
class Sample2Adapter  extends MapViewPager.Adapter {
    ...
    public static final String[] TITLES_test = {  sText ,String.valueOf(R.string.hram2), String.valueOf(R.string.hram3),String.valueOf(R.string.hram4), String.valueOf(R.string.hram5) };

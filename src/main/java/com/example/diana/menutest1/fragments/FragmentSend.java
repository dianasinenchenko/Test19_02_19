...
public class FragmentSend extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       /* RecyclerView recyclerView =  (RecyclerView) view.findViewById(R.id.recyclerview_id);
        ...
        lstPlace.add(new Place("Леса / Лесопарки",R.drawable.les));
        lstPlace.add(new Place("Парки / Скверы / Зоны отдыха",R.drawable.park));
        lstPlace.add(new Place("Озера ",R.drawable.ozero2));
        lstPlace.add(new Place("Реки",R.drawable.reka));


        RecyclerViewAdapter2 myAdapter = new RecyclerViewAdapter2(lstPlace);
